    ...
    <SuccessContainer>
      ...
      <Content>
        <OrderInfo>
          ...
          <FeatureItem color='primary-400' text={["Previsão de entrega", "20 min - 30 min"]} icon="Timer"/>
          <FeatureItem color='primary-700' text={["Pagamento na entrega", "Cartão de Crédito"]} icon='CurrencyDollar' />
        </OrderInfo>
